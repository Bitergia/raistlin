      ...
      <form class="form-horizontal" style="margin: 0 auto">
          ...
          <div class="control">
            <div class="select is-fullwidth">
              <select
                name="selectbackend"
                class
                v-model="taskData.backendSelected"
              >
                <option
                  v-bind:key="backend"
        ...
        <div v-if="taskData.backendSelected === 'git'">
          ...
          <div class="field">
            ...
            <div class="control">
              <div class="select is-fullwidth">
                <select name="selectGitCategory" v-model="taskData.category">
        ...
        <div v-else-if="taskData.backendSelected === 'bugzillarest'">
          ...
          <div class="field">
            ...
            <div class="control">
              <div class="select is-fullwidth">
                <select name="selectBugzillarestCategory" v-model="taskData.category">
                  <option>bug</option>
                </select>
              </div>
            </div>
